...
cluster$pathological_response <- factor(cluster$pathological_response,levels = c("pCR","MPR","pPR","nPR"))

ggscatter(cluster, 
          x = "clonotype_number",
          y = "Freq", color = "pathological_response",shape = "Treg_level")+
  scale_color_manual(values=c("nPR" = "#EDB752","pPR" = "#FFC1B3","MPR" = "#AFD483","pCR" = "#469832"))+ ylim(0,1)+xlim(0,400)
