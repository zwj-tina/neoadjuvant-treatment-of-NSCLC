...
head(sample.info)
sample.info <- sample.info[sample.info$sampleID %in% LUSC.group$sampleID,]
...
ha = HeatmapAnnotation(smokingHistory = factor(info.matrix$smoking_history, levels = c("Y","N","unknown")),
                       ...
                       col = list(smokingHistory = c("Y" = "#F6E382","N" = "#B8DCC5","unknown" = "#82B0D2"),
                                  ...
                                  pathologicalResponse = c("nPR" = "#EDB752","pPR" = "#FFC1B3","MPR" = "#AFD483","pCR" = "#469832"),
...
a <- Heatmap(plot_matrix, name = "ratio",
             ...
             column_order = order(factor(info.matrix$pathological_response, levels = c("nPR","pPR","MPR","pCR"))),
